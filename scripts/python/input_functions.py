...
def rate_cye1_prod(e2f, k_e2f_cye1, n_e2f_cye1=4.0):
  return HillCube(e2f, k_e2f_cye1, n_e2f_cye1, normalized=True)
...
def rate_e2f_prod(e2f, cyd1, myod, cki1, cye1, km_e2f, e2f_tot=1.0):
  """
  ...
  active_cyd1 = cyd1 * (1.0 - myod) * (1.0 - cki1)
  active_cye1 = cye1 * (1.0 - cki1)
  return (active_cyd1 + active_cye1) * (e2f_tot - e2f) / ((e2f_tot - e2f) + km_e2f)

def prod_lin35_by_myod(myod, k_myod_lin35, n_myod_lin35=4.0):
...
def rate_differentiation(myod, cyd1, fos1, lin35, kd_myod, kd_fos1, n_myod=4.0, n_fos1=4.0):
  """
  ...
  myod_klaar = myod * (1.0 - cyd1) * lin35
  myod_bound = HillCube(myod_klaar, kd_myod, n_myod, normalized=True)
